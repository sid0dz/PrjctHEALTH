...
<title>{{App\Clconfig::first()->sitename}}</title>
...
<a href="/login">
<i class="fa fa-user"></i> Espace personel
</a>
</div>
</div>
...
<ul>
<li><a href="#"> <i class="fa fa-map-marker"></i>{{App\Clconfig::first()->siteadress}}</a></li>
<li><a href="#"> <i class="fa fa-envelope"></i> <span class="__cf_email__" data-cfemail="157c7b737a55717a767870713b767a78">{{App\Clconfig::first()->siteemail}}</span></a></li>
<li><a href="#"> <i class="fa fa-phone"></i>{{App\Clconfig::first()->sitenumber}}</a></li>
</ul>
</div>
</div>
</div>
...
<div class="logo">
  <table><tr><td rowspan="2"><a href="index.html">
<img src="{{asset('img/sitelogo.png')}}" height="50" alt=""></td><td style="padding-left: 5px"><a href="index.html"> {{App\Clconfig::first()->sitename}}<td><td></tr>
  </table>
</a>
</div>
</div>
...
<a class="popup-with-form" href="#test-form">Demander Rendez-vous</a>
</div>
</div>
</div>
<div class="col-12">
...
<h3> <span>{{App\Clconfig::first()->sitename}}</span> <br>
 est là pour vous </h3>
<p>On vous offre le meilleur service medical pour votre santé <br> Notre clinique comprend des medecins haut gradé <br>pour assurer vos soins</p>
<a href="#test-form" class="boxed-btn3 popup-with-form">Prendre Rendez-vous</a>
</div>
</div>
</div>
</div>
...
<div class="footer_logo">
  <table><tr><td rowspan="2"><a href="index.html">
    <img src="{{asset('img/sitelogo.png')}}" height="50" alt=""></td>
    <td style="padding-left: 6px;"><h3 class="footer_title">
      <a href="index.html"> <br><br>{{App\Clconfig::first()->sitename}}<td><td></tr>
      </table>
    </a>
</div>
<p>
...
+10 367 467 8934 <br>
<a href="https://preview.colorlib.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c1a5aea2aca4a581a2aeafb5a0a2b5efa2aeac">[email&#160;protected]</a>
</p>
</div>
</div>
</div>
...
Copyright &copy;<script data-cfasync="false"></script><script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com/" target="_blank">Colorlib</a>
...
<div class="col-xl-3">
  <select  style="font-size: 0.8rem;border-radius: 50px;padding: 0.8rem 5rem;" id="heure" 
  placeholder="Heure souhaité">
<option disabled="disabled"  selected="selected"required>Heure</option>
...
<div class="col-xl-3">
  <select  style="font-size: 0.8rem;border-radius: 50px;padding: 0.8rem 5rem;" id="heurmn"
  placeholder="Heure souhaité" required>
<option disabled="disabled">souhaité</option>
...
onblur="(this.type='text')" max={{date('Y-m-d')}} id="birthday" placeholder="Date de naissance" required>
</div>
<div class="col-xl-6">
<input type="text" id="phone" placeholder="Numero de telephone" required>
</div>
<div class="col-xl-6">
<input type="email" id="email" placeholder="Email" required>
</div>
  <div class="col-xl-6">
    <h5> Etes vous deja passé par notre clinique ? </h5> </div>

    <div class="col-xl-6">
      <select class="form-select wide" id="default-select" class="" required>
  <option data-display="Faites votre choix"  disabled="disabled">Faites votre choix</option>
  <option value="1">Oui</option>
  <option value="0">Non</option>
  </select>
    </div>
    <div class="col-xl-12">
      <input type="text" id="motif" placeholder="Motif de rendez-vous">

    </div>
<div class="col-xl-12"></form>

<a  onclick="sbtrdv();" class="boxed-btn3">Confirm</a>
</div>
</div>
</div>
</div>
...
var hr = e.options[e.selectedIndex].value;

e = document.getElementById("heurmn");
var mn = e.options[e.selectedIndex].value;

e = document.getElementById("default-select");
var dejap = e.options[e.selectedIndex].value;

var date  =       document.getElementById('date').value;

var heure =       hr+mn;

var departement=  document.getElementById('dep').value;

var medecin=      document.getElementById('docteur').value;
...
xhr.open("get", "/rdv/"+date+"/"+heure+"/"+departement+"/"+medecin+"/"+name+"/"+birthday+"/"+phone+"/"+email+"/"+dejap+"/"+motif, true);
xhr.onload = function () {
...
<!-- Mirrored from preview.colorlib.com/theme/docmed/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Feb 2021 10:32:36 GMT -->
</html>