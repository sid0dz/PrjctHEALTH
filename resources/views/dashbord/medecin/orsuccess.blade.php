...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
    <a class="btn btn-primary float-right" onclick="printDiv('printableArea')">  <i class="fas fa-print mr-2"></i>Imprimer Lettre</a>
    <a class="btn btn-secondary float-left" href="/show_infos/{{$or->patient_id}}">  <i class="fas fa-arrow-left mr-2"></i>Retourner a la pages d'infos</a>
...
<h3><table class="table mt-5">
    <tr><th colspan="2" class="text-center">Lettre d'orientation </th> </tr>
    <tr><th>Nom: </th> <td> {{$pname}}</td> </tr>
        <tr>­</tr>
    <tr><th>Medecin: </th> <td>{{Auth::user()->fname}} {{Auth::user()->lname}} </td> </tr>
    <tr></tr>
    <tr><th>Date: </th> <td> {{date('Y-m-d')}}</td> </tr>
    <tr></tr>
    <tr><th colspan="2"><div class="text-left"> Contenu:  </div></th> </tr> 
